...
namespace IMDB.Services
{
	public sealed class UserServices : IUserServices
	{
		...
		public void Register(string userName, string password)
		{
			...
			Validator.IfIsInRangeInclusive<int>(password.Length, MIN_PASS_LENGTH, MAX_PASS_LENGTH, "Passwrod should be between 4 and 16 symbols long!");
			Validator.IfIsInRangeInclusive<int>(password.Length, MIN_USERNAME_LENGTH, MAX_USERNAME_LENGTH, "Username should be between 4 and 16 symbols long!");
